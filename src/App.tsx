...
import athenaLgImg from './assets/athena4.png';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg-white relative overflow-x-hidden">
      <div className={` h-screen absolute left-0 w-full pointer-events-none z-70 transition-opacity duration-300 ${isNavOpen ? 'opacity-0' : 'opacity-100'}`}>
              <img 
                src={rippleHero} 
                alt="Ripple Divider" 
                className=" absolute -bottom-50 w-full scale-120 h-100 brightness-0 invert" 
              />
            </div>
            <Navbar isOpen={isNavOpen} setIsOpen={setIsNavOpen} />
            <div className="w-full">
              <main className="flex flex-col">
                  <div className="relative h-screen overflow-hidden bg-brand-bg-white w-[calc(100%-80px)] md:w-[calc(100%-96px)]">
                    <img 
                      src={heroImg} 
                      alt="Hero Background" 
                    ...
                    <img
                        ...
                        className="w-40.5 md:w-64 h-auto z-1 -ml-4 md:-lg-0"
                      />
                      <div className='pt-3.25 [@media(max-width:627px)]:hidden'>
                    ...
                    <div className="flex flex-col md:flex-row items-stretch w-full h-screen overflow-hidden -mt-6">
                    <div className="relative w-full md:w-1/2 h-[55%] min-h-75 md:h-full flex flex-col px-6 sm:px-8 md:px-10 lg:px-20 xl:px-24 md:order-last z-20 ">
                        <h1 className="font-heading text-[32px] sm:text-[40px] md:text-[42px] lg:text-[56px] xl:text-[72px] font-medium leading-[1.1] tracking-normal uppercase transition-all">
                          BECOME AN <span className="text-brand-maroon md:pl-1.5 lg:pl-3 block sm:inline">AFFILIATE</span> OF THE LAW SOCIETY
                        </h1>

                        <p className="font-body text-[14px] sm:text-[15px] lg:text-[18px] font-normal text-brand-black/80 mt-3 sm:mt-4 lg:mt-6 max-w-[95%] md:max-w-[90%] lg:max-w-lg leading-relaxed tracking-[0.01em] transition-all">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dict...
                        </p>
                        <a 
                          href="#" 
                          className="text-[15px] sm:text-[16px] md:text-[18px] group inline-flex items-center mt-5 sm:mt-6 lg:mt-8 font-body text-brand-gold font-bold tracking-widest hover:text-brand-maroon transition-colors w-fit"
                        >
                          FIND LAWYER 
                          <img
                            src={arrow}
                    ...
                    <picture className="w-full h-full flex items-end pointer-events-none z-10">
                      <source media="(min-width: 624px)" srcSet={athenaLgImg} />
                      
                      <img
                        src={athenaImg}
                        alt="Athena"
                        className="w-full h-full object-contain object-bottom md:object-bottom-left origin-bottom-left -translate-y-18 md:translate-y-0 transition-transform duration-300"
                      />
                    </picture>
                  </div>
                </div>
                ...
                <div className="w-full bg-brand-bg-white p-16 md:p-16 lg:px-24">
                  <div className="max-w-xl lg:max-w-5xl mx-auto">
                    <div className="relative right-9.5 flex items-center space-x-3 mb-5">
                  ...
                  <div className="w-full grid grid-cols-2 lg:grid-cols-4 border-y border-gray-300">
                    {cards.map((card, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="relative h-50 md:h-80 lg:h-95 w-full overflow-hidden flex flex-col justify-between p-4 md:p-8">
                            <img
                              src={card.img}
                              alt={card.title}
                            ...
                            <div className="relative z-20 mt-auto mb-2 md:mb-4">
                              ...
                              >
                                ...
                                >
                                <p className="font-body text-[18px] font-normal text-gray-300 whitespace-pre-line leading-7.5 tracking-normal">
                                  {card.desc}
                                </p>
                              </div>
                            </div>
                          ...
                          <div
                            className={`h-12.5 md:h-17.5 border-t border-gray-300 flex items-center justify-center transition-colors duration-300 ${
                              isActive ? 'bg-[#987F55]' : 'bg-brand-bg-white'
                            }`}
                          >
                            <div
                              className={`flex ${index === 2 ? 'md:mr-15' : ''} mr-22.5 items-center space-x-2 text-[12px] md:text-sm transition-colors duration-300 ${
                                isActive ? 'text-white font-bold tracking-widest' : 'text-gray-500'
                              }`}
                            >
                              {isActive && (
                                <span className="hidden md:inline font-body text-[18px] font-semibold uppercase leading-7.5 tracking-[0.01em]">
                                  MORE DETAIL
                                </span>
                              )}
                              <div className="flex items-center">
                                <img
                                  src={arrowBlackImg}
                                  alt="Arrow Icon"
                                  className="scale-90 relative right-0"
                                />
                              </div>
                            </div>
                          </div>
                ...
                <div className="relative w-full h-100 md:h-137.5 flex flex-col items-center justify-center bg-[#222222]">
                  <img
                    src={Background60Img}
                  ...
                  <div className="relative z-20 flex flex-col items-center w-full max-w-6xl mx-auto px-4">
                    <div className="relative w-full md:w-auto flex items-center justify-center py-5 md:py-6 px-6 md:px-20 mb-8 md:mb-12">
                      <div className="md:top-15  top-16 opacity-80 absolute bg-[#A31636] skew-x-[-30deg] shadow-lg h-22.5 w-[84%] md:w-[90%] left-[47%] -translate-x-1/2"></div>
                      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-8 text-white text-center">
                        <span className="relative right-5 md:bottom-1.25 font-heading text-[28px] md:text-[54px] font-normal leading-none tracking-normal uppercase md:mt-3">
                          Celebrating
                        </span>
                        <div className="flex items-start">
                          ...
                          <span className="relative md:bottom-7.5 bottom-5 font-heading text-[28px] md:text-[42px] font-normal leading-none tracking-normal uppercase mt-2 md:mt-4">
                            TH
                          </span>
                        </div>
                        <span className="relative right-3.75 md:right-10 md:bottom-1.25 font-heading text-[28px] md:text-[54px] font-normal leading-none tracking-normal uppercase md:mt-3">
                          Anniversary
                        </span>
                      </div>
                    </div>
                  ...
                  <div className={`absolute -bottom-50 left-0 w-full pointer-events-none z-70 transition-opacity duration-300`}>
                    <img 
                      src={rippleHero} 
                      alt="Ripple Divider" 
                      className="w-full h-100 brightness-0 invert scale-195" 
                    />
                  </div>
                </div>
                <div className="relative w-full bg-brand-bg-white py-12 md:py-24 px-8 md:px-16 lg:px-24 overflow-hidden">
                  <div className="absolute top-0 right-0 w-[60%] md:w-[40%] h-full opacity-40 bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-gray-200 via-transparent to-transparent pointer-events-none z-0"></div>
                ...
                <div className="w-full flex flex-col items-center">
                  <div className="pt-10 border-t border-gray-300 w-[90%] max-w-6xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-x-16 lg:gap-y-0 items-start">
                      <div className="order-1 lg:order-0 lg:col-start-2 lg:row-start-1 flex justify-center lg:justify-end items-center space-x-3 md:space-x-4 font-heading text-[32px] md:text-[42px] tracking-widest font-medium mb-4 lg:mb-8">
                      ...
                      <div className="order-2 lg:order-0 lg:col-start-1 lg:row-start-1 lg:row-span-2 w-full">
                        <img 
                          src={photo1Img} 
                      ...
                      <div className="order-3 lg:order-0 lg:col-start-2 lg:row-start-2 flex flex-col pt-0 lg:pt-4">
                ...
                <div 
                  ...
                  <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col space-y-2 md:space-y-4 max-w-5xl mx-auto">
                      {legalSupports.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            <div className="w-18.75 md:w-32.5 shrink-0 bg-[#3A3A3A] text-white flex items-center justify-center py-3 md:py-5 font-heading tracking-wide text-[13px] md:text-[18px]">
                              {item.type}
                            </div>
                            <div 
                    ...
                    <div className="mt-10 md:mt-16 flex justify-center">
                      <a 
                        href="#" 
                        className="group flex items-center font-body text-[18px] font-semibold uppercase tracking-[0.01em] leading-7.5 text-[#987F55] hover:text-brand-maroon transition-colors"
                      >
                        ...
                        <div className="flex overflow-hidden gap-6">
                          {[1, 2, 3].map((n) => (
                            <div key={n} className="flex-none w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] flex flex-col animate-pulse">
                              <div className="w-full h-50 lg:h-60 bg-gray-300 mb-4 rounded-sm"></div>
                      ...
                      {!loadingNews && !newsError && (
                        <>
                          <button 
                            ...
                            className="absolute -left-3.75 lg:-left-10 top-25 z-10 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center text-brand-maroon opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300"
                          >
                          ...
                          <button 
                            ...
                            className="absolute -right-3.75 lg:-right-10 top-25 z-10 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center text-brand-maroon opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300"
                          >
                          ...
                          >
                            {articles.map((article) => (
                              ...
                              >
                                <div className="w-full h-50 lg:h-60 overflow-hidden mb-5 bg-gray-200">
                                  <img 
                                    src={article.image} 
                                    alt={article.title} 
                                ...
                                <p className="mt-4.25 font-body text-[16px] font-semibold text-gray-800 mb-3 tracking-normal leading-none">
                                  {article.category} | <span className="font-normal">{article.date}</span>
                                </p>
                                <p className="font-body text-[18px] font-normal text-gray-600 leading-7.5 tracking-normal line-clamp-3 mb-6">
                                  {article.excerpt}
                                </p>
                                <a 
                                  href={article.url}
                                  ...
                                  className="mt-auto group/link flex items-center font-body text-[18px] font-semibold uppercase leading-7.5 tracking-[0.01em] text-[#987F55] hover:text-brand-maroon transition-colors"
                                >
                                  MORE DETAIL
                                  <div className="flex items-center ml-2.5 scale-90 mt-0.75">
                                  <img
                                    src={arrow}
                                    alt="Arrow Icon"
                                    className="scale-90 relative right-0"
                ...
                <div className="relative w-full h-162.5 md:h-50 flex flex-col md:flex-row items-center ">
                  <div 
                  ...
                  >
                    <div className="opacity-87 hidden md:block absolute top-0 right-[-20%] md:h-full w-[65%] bg-[#AA0433] skew-x-25 origin-bottom-left"></div>
                  ...
                  <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-16 flex flex-col md:flex-row items-center justify-between h-full pt-12 md:pt-0">
                    <div className="w-full md:w-[50%] flex flex-col md:flex-row items-start text-left gap-4 md:gap-6 mt-0">
                      <div className="mt-0 md:mt-2 shrink-0">
                        <img 
                          src={briefImg} 
                          alt="Briefcase Icon" 
                          className="w-9 h-9 md:w-10.5 md:h-10.5 object-contain" 
                        />
                      </div>
                      <div className="flex flex-col items-start">
                        ...
                        <p className="font-body text-[18px] font-normal text-gray-700 md:text-gray-600 leading-7.5 tracking-normal mb-6">
                          A guidance on career and work related issues
                        </p>
                      <a href="#" className="group flex items-center justify-start font-body text-[18px] font-semibold text-[#987F55] leading-7.5 tracking-[0.01em] uppercase hover:text-[#A31636] transition-colors w-fit">
                          FIND CAREER
                            <img
                                src={arrow}
                                alt="Arrow Icon"
                                className="scale-90 relative right-0 ml-1.5"
                            />
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex absolute bottom-0 left-0 w-full h-[55%] md:h-full md:w-[50%] md:left-auto md:right-0 md:top-0 items-center justify-center z-20 pointer-events-none">
                      <img 
                        ...
                        className="absolute -mb-4.5  md:mb-10 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:bottom-[-20%] h-[95%] md:h-[140%] object-contain md:right-[15%] drop-shadow-2xl pointer-events-auto" 
                      />
                    </div>
                  </div>
                </div>
